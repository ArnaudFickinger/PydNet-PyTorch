...
class MainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--use_dropout', action='store_true', default=True,
        ...
        self.parser.add_argument('--filename', type=str,
                                 default='../dataset/filenames/kitti_train_files_mini.txt')  # kitti_temp_files_test.txt / kitti_train_files_mini.txt / kitti_train_files.txt
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='pydnet', help='select arch for netG [pydnet]')

        # for training
        self.parser.add_argument('--niter', type=int, default=50, help='# of iter at starting learning rate')
        self.parser.add_argument('--niter_decay', type=int, default=5,
        ...
        self.parser.add_argument('--headstart', type=int, default=-1,
                                 help='# of headstart training iteration for G. # epoch. -1 for off')
        self.parser.add_argument('--headstart_switch', type=int, default=0,
                                 help='switch to turn on discriminator. 0 for off and -1 for on')
        ...
        self.parser.add_argument('--ckpt_folder', type=str, default='backup_ckpts',
        ...
        self.parser.add_argument('--which_epoch', type=int, default=0,
                                 help='which epoch to be loaded eg. 10,20,30,40,50. if zero, load latest model')

        # train or test
        self.parser.add_argument('--isTrain', action='store_true', default=True, help='if true, training else testing')

        # test files
        self.parser.add_argument('--ext_test', action='store_true', default=False,
                                 help='if true, reading external test files')
        self.parser.add_argument('--filename_test', type=str, default='../dataset/filenames/kitti_temp_files_test.txt',
                                 help='test filename')  # kitti_temp_files_test.txt
        self.parser.add_argument('--ext_filename_test', type=str,
                                 default='./checkpoints/monodepth/test_img_in/filename_test.txt',
                                 help='ext test filename')
        self.parser.add_argument('--ext_test_in', type=str,
                                 default='/media/Data/Alwyn/monodepth/checkpoints/DepthGAN/test_img_in',
        ...
        self.parser.add_argument('--use_html', action='store_true', default=True,
                                 help='if specified, it will use html page or else tensorboard logging')
        self.parser.add_argument('--individual_loss_disp', action='store_true', default=True,
                                 help='if true, will plot individual loss')
        ...
        self.parser.add_argument('--debug', action='store_true', default=False,
                                 help='if true, find gradient in computational graph')
        self.parser.add_argument('--graph', action='store_true', default=False,
                                 help='if true, build graph in tensorboard')
